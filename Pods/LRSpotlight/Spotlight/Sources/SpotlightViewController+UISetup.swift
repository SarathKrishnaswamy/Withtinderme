...
extension SpotlightViewController {
    ...
    func setupInfoView() {
        ...
        infoStackBottomConstraint = infoStackView.bottomAnchor.constraint(equalTo: bottomLayoutGuide.topAnchor, constant: -150)
    ...
    func createCloseButton() -> UIButton {
        let button = UIButton()
        let image = UIImage(named: "", in: Bundle(for: type(of: self)), compatibleWith: nil)
