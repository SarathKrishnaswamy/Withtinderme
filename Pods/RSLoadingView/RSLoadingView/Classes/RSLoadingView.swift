...
public class RSLoadingView: UIView, SCNSceneRendererDelegate {
  ...
  fileprivate var effect: RSLoadingViewEffect = RSLoadingTwins()
  ...
  public var sizeInContainer: CGSize = CGSize(width: 150, height: 150)
  ...
  public func showOnKeyWindow() {
      show(on: UIApplication.shared.keyWindow ?? UIWindow())
  }
  ...
  static public func hideFromKeyWindow() {
    hide(from: UIApplication.shared.keyWindow ?? UIWindow())
  }
