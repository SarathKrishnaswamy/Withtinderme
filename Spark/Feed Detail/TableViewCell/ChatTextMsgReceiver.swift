...
protocol anonymousDelegate : AnyObject {
    func anonymousFunction(sender: UIButton)
}

/// This cell is used to receive the message from other user in the left side of the screen
class ChatTextMsgReceiver: UITableViewCell {
    ...
    weak var anonymousDelegate : anonymousDelegate?
    ...
    ///Anonymous button tapped to reveal the user 
    @IBAction func anonymousButtonTapped(_ sender: UIButton) {
        anonymousDelegate?.anonymousFunction(sender: sender)
      }
