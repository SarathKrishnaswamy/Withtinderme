...
/**
 This class is used to set the audio player with the running option with play, resume and setup the player and
 */
...
/// Play with audio visualization
    ...
    /// Play according to the each time interval manner 
