//
//  FeedDetailTableViewCellViewModel.swift
//  Spark me
//
...
class FeedDetailTableViewCellViewModel {

    private var userListData:PostDetails?
    
    init(withModel:PostDetails?)
      {
    ...
    public var currencySymbol: String {
        return self.userListData?.currencySymbol ?? ""
    }
