...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var cornerRadiuss: CGFloat = 0 {
        didSet {
            tagViews.forEach {
                $0.cornerRadiuss = cornerRadiuss
            }
        }
    }
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagBackgroundView.layer.shadowPath = UIBezierPath(roundedRect: tagBackgroundView.bounds, cornerRadius: cornerRadiuss).cgPath
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.cornerRadiuss = cornerRadiuss
